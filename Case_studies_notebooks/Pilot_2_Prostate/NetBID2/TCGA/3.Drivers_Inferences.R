...
project_name <- "Prostate_NetBID2" # project name for the project folders under main directory
sit_0 <- "N0" 
sit_1 <- "N1"
Condition <- "ajcc_pathologic_n"
...
phe_info$Status <- str_replace_all(phe_info$Status, "Stage_IV", "Progressive")
phe_info$Status <- str_replace_all(phe_info$Status, "Stage_III", "Progressive")
phe_info$Status <- str_replace_all(phe_info$Status, "Stage_II", "Mild")
phe_info$Status <- str_replace_all(phe_info$Status, "Stage_I", "Mild")
